...
return [
    ...
    'attendance_status' => [
        ...
        3 => ['status' => 'global.attendance.on_leave', 'color' => 'bg-blue-200 hover:bg-blue-300 dark:bg-blue-900 dark:hover:bg-blue-800'],
        4 => ['status' => 'global.attendance.undertime', 'color' => null],
        5 => ['status' => 'global.attendance.holiday', 'color' => 'bg-white hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-800'],
        6 => ['status' => 'global.attendance.overtime', 'color' => null],
        7 => ['status' => 'global.attendance.no_schedule', 'color' => 'bg-white hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-800'],
    ],
