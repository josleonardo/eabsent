<x-layout>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @foreach ($users as $key => $user)
                    <tr
                        class="{{ $user->active != 1 ? 'bg-red-300 hover:bg-red-400 dark:bg-red-900 dark:hover:bg-red-800' : 'bg-gray-50 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700'}} border-b border-gray-200 dark:border-gray-700">
    ...
    {{-- <p class="w-full mt-3 font-semibold text-right rtl:text-left text-gray-500 sm:py-4 sm:hidden dark:text-gray-400">
