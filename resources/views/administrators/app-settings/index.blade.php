<x-layout>
    ...
    @else
                ...
                <tbody>
                    @foreach ($appSettings as $key => $appSetting)
                        <tr
                            ...
                            <td class="px-4 py-3">{{ $appSetting->name }}</td>
                            ...
                            <td class="px-4 py-3 text-center">{{ $appSetting->updated_by }}</td>
                            <td class="px-4 py-3 text-right">
                                <a href="{{ route('app-setting.edit', $appSetting) }}"
        ...
        <div class="my-4">{{ $appSettings->onEachSide(2)->links() }}</div>
    @endif
</x-layout>
