                ...
                <tbody>
                    @foreach ($users as $key => $user)
                        @foreach ($user->levels as $level)
                            <tr
                                class="{{ !$level->pivot->active ? 'bg-red-300 hover:bg-red-400 dark:bg-red-900 dark:hover:bg-red-800' : 'bg-gray-50 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700' }} border-b border-gray-200 dark:border-gray-700">
                                <th scope="row"
                                ...
                                <td class="px-4 py-3">{{ $level->pivot->active ? 'Yes' : 'No' }}</td>
