<x-layout>
    ...
    <section class="p-3 space-y-6 border border-gray-200 sm:p-4 dark:bg-gray-800 dark:border-gray-700">
        ...
        {{-- Create form --}}
        <form action="{{ route('setting.store') }}" method="POST" class="space-y-6 max-w-7xl">
            @csrf
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="w-full">
                    ...
                    <input type="text" name="setting_name" id="setting_name" required value="{{ old('setting_name') }}"
                ...
                <div class="w-full">
                    ...
                    <input type="text" name="value_1" id="value_1" value="{{ old('value_1') }}"
                        class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 border border-gray-200 placeholder:text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-600 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    @error('value_1')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"> {{ $message }}</p>
                    @enderror
                ...
                <div class="w-full">
                    ...
                    <input type="text" name="value_2" id="value_2" value="{{ old('value_2') }}"
                        class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 border border-gray-200 placeholder:text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-600 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    @error('value_2')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"> {{ $message }}</p>
                    @enderror
