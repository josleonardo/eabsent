    ...
    <section class="p-3 space-y-6 border border-gray-200 sm:p-4 dark:bg-gray-800 dark:border-gray-700">
        ...
        <form action="{{ route('role.store') }}" method="POST" class="space-y-6 max-w-7xl">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="w-full">
                    <label for="role_name" class="block mb-2 text-sm/6 font-medium text-gray-900 dark:text-white">
                        Role Name
                    </label>
                    <input type="text" name="role_name" id="role_name" required value="{{ old('role_name') }}"
